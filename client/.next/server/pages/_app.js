...
const LeftSide_S = {
  ...
  })(["margin-bottom:15px;.wrapper{border:1px solid #eaeaea;display:flex;justify-content:space-between;align-items:center;border-radius:10px;padding:3px;position:relative;width:100px;li{text-align:center;width:50px;color:#555;font-size:14px;cursor:pointer;}span{position:absolute;background-color:#444;border-radius:10px;padding:2px 0;top:2px;right:3px;width:46px;text-align:center;display:flex;align-items:center;justify-content:center;font-size:13px;color:#fff;cursor:default;", ";transition:transform 0.7s ease-in;}}"], ({
    openSideMenu,
    directionSwap
...
const RightSide_S = {
  ...
  })(["margin-bottom:15px;.wrapper{border:1px solid #eaeaea;display:flex;justify-content:space-between;align-items:center;border-radius:10px;padding:3px;position:relative;width:100px;li{text-align:center;width:50px;color:#555;font-size:14px;cursor:pointer;}span{position:absolute;background-color:#444;border-radius:10px;padding:2px 0;top:2px;left:3px;width:46px;text-align:center;display:flex;align-items:center;justify-content:center;font-size:13px;color:#fff;transform:translateX(0%);cursor:default;", ";}}"], ({
    openSideMenu,
    directionSwap
  }) => openSideMenu && directionSwap === false && (0,external_styled_components_.css)(["transform:translateX(100%);transition:transform 7s ease-in;"])),
  ImageBanner: external_styled_components_default().div.withConfig({
...
const Layout_S = {
  Layout: external_styled_components_default().div.withConfig({
    displayName: "Layout",
    componentId: "nova0-0"
  })(["height:calc(100vh - 40px);display:flex;flex-direction:column;justify-content:space-between;.layout-wrap{flex:1;display:", ";flex-direction:column;main{flex:1;}}"], props => props.isAdminPage ? 'block' : 'flex')
};
